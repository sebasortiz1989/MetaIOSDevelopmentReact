import centralPark from '../DisplayImages/assets/images/centralPark.jpg'
...
function DisplayImages(props) {
    ...
    return (
        <div>
            ...
            <img height={200} src={require("../DisplayImages/assets/images/centralPark.jpg")} alt="An image in new york"/>
